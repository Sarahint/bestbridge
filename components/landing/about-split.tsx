...
type AboutSplitContent = typeof landingContent.home.aboutSplit;

export function AboutSplit({ content }: { content: AboutSplitContent }) {
  return (
    <section aria-labelledby="about-split-heading" className="bb-section bg-bg-soft">
      <div className="bb-container grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
        ...
        <div>
          ...
          <h2 id="about-split-heading">{content.heading}</h2>
